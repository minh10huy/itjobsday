INSERT INTO `tbl_admin` (`id`, `username`, `passwd`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3');

INSERT INTO tbl_payment_modules (id, name, module_key, class_file, formfile, enabled) VALUES 
(1, 'PayPal', 'paypal', 'paypal.php', 'frmpaypal.tpl', 'N');

REPLACE INTO tbl_setting_category (id, category_name, var_name, category_desc ) VALUES 
...
REPLACE INTO tbl_setting (id, fk_category_id, setting_name, title, description, data_type, input_type, input_options, validation, value) VALUES
...
INSERT INTO `tbl_career_degree` (`id`, `var_name`, `career_name`, `is_active`) VALUES
...
INSERT INTO `tbl_category` (`id`, `var_name`, `cat_name`) VALUES
...
INSERT INTO `tbl_education` (`id`, `var_name`, `education_name`, `is_active`) VALUES
...
INSERT INTO `tbl_experience` (`id`, `var_name`, `experience_name`, `is_active`) VALUES
...
INSERT INTO `tbl_job_status` (`id`, `var_name`, `status_name`, `is_active`) VALUES
...
INSERT INTO `tbl_job_type` (`id`, `var_name`, `type_name`, `is_active`) VALUES
