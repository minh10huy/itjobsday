...
CREATE TABLE IF NOT EXISTS tbl_package_invoice (
...
CREATE TABLE IF NOT EXISTS tbl_payments_invoice (
...
CREATE TABLE IF NOT EXISTS tbl_job2category (
...
CREATE TABLE IF NOT EXISTS  tbl_job2type (
...
CREATE TABLE IF NOT EXISTS  tbl_job2status (
	fk_job_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS  tbl_career_degree (
	id 			INT NOT NULL AUTO_INCREMENT,
	var_name 	VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  tbl_save_job (
	id 				INT NOT NULL AUTO_INCREMENT,
	fk_employee_id 	INT NOT NULL,
	fk_job_id 		BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS  tbl_save_search (
	id 				INT NOT NULL AUTO_INCREMENT,
	fk_employee_id 	INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS  tbl_cv_detail (
	id 					INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS tbl_cv_category (
	cv_id  		INT NOT NULL,
	category_id INT NOT NULL,
	PRIMARY KEY(cv_id, category_id )
);

CREATE TABLE IF NOT EXISTS tbl_cv_look_occupation (
	cv_id  		INT NOT NULL,
	category_id INT NOT NULL,
	PRIMARY KEY(cv_id, category_id )
);

CREATE TABLE IF NOT EXISTS tbl_covering_letter (
	id 				INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS tbl_cv_view (
	id 	   			INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS tbl_payment_modules (
...
CREATE TABLE IF NOT EXISTS tbl_plugin_config (
	id 				int	NOT NULL auto_increment,
